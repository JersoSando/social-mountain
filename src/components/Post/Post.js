      ...
      <section className="Post__parent" onClick={ this.hideMasterMenu }>
        ...
        <div className="Post__master-controls">
          ...
          <div className="Post__master-menu" style={ { display: showMasterMenu ? 'flex' : 'none' } }>
            ...
            <span onClick={() => this.props.deletePostFunc(this.props.postInfoObj.id)}>Delete</span>
          </div>
        </div>
        ...
        <div className="Post__meta-data">
          ...
          <span className="Post__date">- {this.props.postInfoObj.date}</span>
        </div>
        ...
        <div className="Post__content">
          {
            ...
            ?
              <Edit 
                ...
                updatePostFunc={this.props.updatePostFunc}
                id={this.props.postInfoObj.id}
              />
            :
              <span className="Post__text">{this.props.postInfoObj.text}</span>
          }
        </div>
